...
from . import views
from .views import insert_databaetembb
...
urlpatterns = [
    ...
    path('insert-databaetembb/', insert_databaetembb, name='insert_databaetembb'),
    path('kv1tokv2', views.kv1tokv2, name='kv1tokv2'),

    path('tembbcusangkd', views.tembbcusangkd, name='tembbcusangkd'),

    path('kiemtratieuchuantheomay', views.kiemtratieuchuantheomay, name='kiemtratieuchuantheomay'),
